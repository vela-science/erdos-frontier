...
|---|---:|---|
| `statement` | 99 | **Write the FC statement + link.** A complete hosted proof exists, FC has no file yet. |
...
| `hypothesis-conditional` | 13 | **Do not link as complete.** The theorem carries a non-problem hypothesis even if `#print axioms` is clean. |
...
## `hypothesis-conditional` — 13 problem(s)
...
- [296](https://www.erdosproblems.com/296)ᵖʲ — Do not add a formal_proof link; document or wait for an unconditional theorem.
