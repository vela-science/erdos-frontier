# Erdős Problem 618 — drafting inputs
...
<title>618 | Erdős Problems</title>
<meta property="og:title" content="618 | Erdős Problems">
...
<div class="container">
  ...
  A problem of Erd\H{o}s, Gy\'{a}rf\'{a}s, and Ruszink\'{o} \cite{EGR98}. Simonovits showed that there exist graphs $G$ with maximum degree $\gg n^{1/2}$ and $h_2(G)\gg n^2$.<br><br>Erd\H{o}s, Gy\'{a}rf\'{a}s, and Ruszink\'{o} \cite{EGR98} proved that if $G$ has no isolated vertices and maximum degree $O(1)$ then $h_2(G)\ll n\log n$. <br><br>Alon has observed this problem is essentially identical to <a href="/134" rel="nofollow noopener noreferrer ugc" target="_blank">[134]</a>, and his solution in <a href="https://web.math.princeton.edu/~nalon/PDFS/remark1901.pdf" rel="nofollow noopener noreferrer ugc" target="_blank">this note</a> also solves this problem in the affirmative.<br><br>See also <a href="/619" rel="nofollow noopener noreferrer ugc" target="_blank">[619]</a>.
  ...
  [EGR98] Erd\H{o}s, Paul and Gy\'{a}rf\'{a}s, Andr\'{a}s and<br>Ruszink\'{o}, Mikl\'{o}s, <i>How to decrease the diameter of triangle-free graphs</i>. Combinatorica (1998), 493-501.
  
  </div>
                                        
  <div class="problem-additional-text" style="text-align:center; padding: 10px;">
  <a href="/618">Back to the problem</a>
  </div>
...
## Hosted theorem — plby (https://github.com/plby/lean-proofs/blob/main/src/v4.29.1/ErdosProblems/Erdos618.lean)
...
## Hosted theorem — jayyhk (https://github.com/Jayyhk/erdos-lean/blob/main/problems/618/Erdos618.lean)
