# Erdős Problem 498 — drafting inputs
...
<title>498 | Erdős Problems</title>
<meta property="og:title" content="498 | Erdős Problems">
...
<div class="container">
  ...
  A strong form of the <a href="https://en.wikipedia.org/wiki/Littlewood%E2%80%93Offord_problem" rel="nofollow noopener noreferrer ugc" target="_blank">Littlewood-Offord problem</a>. Erd\H{o}s \cite{Er45} proved this is true if $z_i\in\mathbb{R}$, and for general $z_i\in\mathbb{C}$ proved a weaker upper bound of\[\ll \frac{2^n}{\sqrt{n}}.\]This was solved in the affirmative by Kleitman \cite{Kl65}, who also later generalised this to arbitrary Hilbert spaces \cite{Kl70}. <br><br>See also <a href="/395" rel="nofollow noopener noreferrer ugc" target="_blank">[395]</a>.
  ...
  [Er45] Erd\H{o}s, P., <i>On a lemma of {L}ittlewood and {O}fford</i>. Bull. Amer. Math. Soc. (1945), 898--902.
  
  [Kl65] Kleitman, Daniel J., <i>On a lemma of Littlewood and Offord on the distribution of certain sums</i>. Math. Z. (1965), 251-259.
  
  [Kl70] Kleitman, Daniel J., <i>On a lemma of Littlewood and Offord on the distributions of linear combinations of vectors</i>. Advances in Math. (1970), 155-157.
  
  </div>
                                        
  <div class="problem-additional-text" style="text-align:center; padding: 10px;">
  <a href="/498">Back to the problem</a>
  </div>
...
## Hosted theorem — plby (https://github.com/plby/lean-proofs/blob/main/src/v4.29.1/ErdosProblems/Erdos498.lean)

```lean
theorem kleitman_bound_theorem {α : Type*} [Fintype α] (F : Set (Set α))
  (T : Set α) :
  (∀ A B, A ∈ F → B ∈ F → A ⊂ B → (B \ A ∩ T).Nonempty ∧ (B \ A ∩ Tᶜ).Nonempty) →
  F.ncard ≤ (Fintype.card α).choose (Fintype.card α / 2)
```
...
## Hosted theorem — jayyhk (https://github.com/Jayyhk/erdos-lean/blob/main/problems/498/Erdos498.lean)
