# Erdős Problem 487 — drafting inputs
...
<title>487 | Erdős Problems</title>
<meta property="og:title" content="487 | Erdős Problems">
...
<div class="container">
  ...
  Davenport and Erd\H{o}s \cite{DaEr36} showed that there must exist an infinite sequence $a_1&lt;a_2\cdots$ in $A$ such that $a_i\mid a_j$ for all $i\leq j$, under the assumption that the upper logarithmic density of $A$ is positive.<br><br>This is true, a consequence of the positive solution to <a href="/447" rel="nofollow noopener noreferrer ugc" target="_blank">[447]</a> by Kleitman \cite{Kl71}.
  ...
  [DaEr36] Davenport, H. and Erd\H{o}s, P., <i>On sequences of positive integers</i>. Acta Arithmetica (1936), 147-151.
  
  [Kl71] Kleitman, Daniel, <i>Collections of subsets containing no two sets and their union</i>. Proceedings of the LA Meeting AMS (1971), 153-155.
  
  </div>
                                        
  <div class="problem-additional-text" style="text-align:center; padding: 10px;">
  <a href="/487">Back to the problem</a>
  </div>
...
## Hosted theorem — plby (https://github.com/plby/lean-proofs/blob/main/src/v4.29.1/ErdosProblems/Erdos487.lean)
...
## Hosted theorem — jayyhk (https://github.com/Jayyhk/erdos-lean/blob/main/problems/487/Erdos487.lean)
