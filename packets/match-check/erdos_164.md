# Match-check packet — Erdős problem 164
...
- **Undischarged named assumptions** (theorem parameters — `#print axioms` cannot see these):
  - `hA : Erdos164.PrimitiveSet A`
  → the proof is conditional on the above; it is NOT an unconditional resolution even if kernel-clean.

## 1. Upstream statement

- Boxed problem: https://www.erdosproblems.com/164
- LaTeX source: https://www.erdosproblems.com/latex/164
...
- plby/lean-proofs — state `complete` (complete)
  - https://github.com/plby/lean-proofs/blob/main/src/v4.29.1/ErdosProblems/Erdos164.lean
- Jayyhk/erdos-lean — state `complete` (complete)
  - https://github.com/Jayyhk/erdos-lean/blob/main/problems/164/Erdos164.lean
